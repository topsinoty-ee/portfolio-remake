  ...
  return (
    <div className="min-h-screen">
      <div className="flex gap-8">
        <article className="lg:border-border lg:bg-card h-max flex-1 overflow-hidden lg:rounded-lg lg:border lg:shadow-sm">
          ...
          <div className="py-6 lg:px-8">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center sm:gap-4">
                {project.link && (
                  <Button variant="outline" className="bg-secondary text-secondary-foreground transition-color" asChild>
                    <Link
                      href={project.link}
                      target="_blank"
